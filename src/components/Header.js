            ...
            <div className="flex flex-col xs:flex-row items-center flex-wrap justify-center gap-2 sm:gap-4">
              ...
              <div className="flex items-center flex-wrap justify-center divide-x divide-neutral-600">
                <button
                  ...
                  className="px-2 sm:px-3 py-1 rounded hover:text-brand-green hover:bg-neutral-700/50 transition-all text-center whitespace-nowrap cursor-pointer"
                >
                  Franchise Enquiry
                </button>
              </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <div className="relative group">
                ...
                >
                  <FaWhatsapp className="text-2xl text-neutral-600 group-hover:text-brand-green transition-colors" />
