...
const ShowroomSection = () => {
  const factoryImages = [
    {
      src: "/images/mallImages/IMG_0064.png",
      alt: "Kalkai Industries Mall - exterior view",
      caption: "The view that defines Glory"
    },
    {
      src: "/images/mallImages/IMG_0069.png",
      alt: "Kalkai Industries production line",
      caption: "Some memories of Opening"
    },
    {
      src: "/images/mallImages/IMG_0499.png",
      alt: "Kalkai Industries quality control area",
      caption: "Explore the inner things"
    },
    {
      src: "/images/mallImages/IMG_0074.png",
      alt: "Kalkai Industries warehouse operations",
      caption: "View of balcony"
    }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Kalika Furniture Mall
          </h2>
          <div className="w-24 h-1 bg-gray-300 mx-auto mb-6"></div>
          <p className="text-gray-600 max-w-3xl mx-auto">
            Turning houses into homes with comfort, style, and trust.
          </p>
        </div>
